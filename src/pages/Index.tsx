  ...
  return (
    <main className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        />
        <div
          className="absolute -bottom-40 -right-40 h-96 w-96 rounded-full blur-3xl opacity-30"
          style={{
            background:
      ...
      />
      <header
        className="container mx-auto max-w-6xl px-4 py-6 flex items-center justify-between sticky top-0 bg-background/80 backdrop-blur-lg z-50 border-b border-border/50"
        role="banner"
      >
          ...
          <div className="grid items-center gap-10 md:grid-cols-2">
            <div>
              ...
              <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
                Capture faces via webcam, detect liveness, match to registered
                profiles, and get instant results — optimized for low bandwidth
                and field operations across Nigeria and Africa.
              </p>
              ...
              <div className="aspect-video w-full rounded-2xl border bg-gradient-to-br from-[hsl(var(--brand)/0.08)] to-[hsl(var(--brand-contrast)/0.08)] shadow-2xl grid place-items-center backdrop-blur-sm">
                <div className="text-center p-8">
                  ...
                  <div className="flex items-center justify-center gap-3 text-sm">
                    <span className="px-3 py-2 rounded-lg border bg-background/50 backdrop-blur-sm font-medium">
                      Capture
                    </span>
                    <svg
        ...
        <div className="container mx-auto max-w-6xl px-4">
          <div className="text-center mb-16">
            ...
            <p className="mt-6 text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Advanced AI-powered system designed for field agents, security
              personnel, and identity verification professionals across Africa
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div className="group p-8 rounded-2xl border bg-card shadow-sm hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-muted-foreground leading-relaxed">
                High-quality webcam capture with automatic face detection,
                positioning guidance, and optimal lighting detection for
                consistent results.
              </p>
            ...
            <div className="group p-8 rounded-2xl border bg-card shadow-sm hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Comprehensive web and social media search using reverse image
                lookup. Discover public profiles, social handles, and identity
                verification data.
              </p>
            ...
            <div className="group p-8 rounded-2xl border bg-card shadow-sm hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Advanced LBPH face recognition with confidence scoring, multiple
                fallback detection methods, and anti-spoofing protection.
              </p>
            ...
            <div className="group p-8 rounded-2xl border bg-card shadow-sm hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Comprehensive identity details including NIN, license info,
                passport data, social media profiles, and verified public
                records.
              </p>
            ...
            <div className="group p-8 rounded-2xl border bg-card shadow-sm hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Role-based authentication system for authorized personnel with
                comprehensive audit trails and access control management.
              </p>
            ...
            <div className="group p-8 rounded-2xl border bg-card shadow-sm hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-muted-foreground leading-relaxed">
                State-of-the-art liveness detection that prevents photo attacks,
                screen spoofing, and deepfake attempts with real-time analysis.
              </p>
          ...
          <div className="mt-16 text-center">
            <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-gradient-to-r from-[hsl(var(--brand)/0.08)] to-[hsl(var(--brand-contrast)/0.08)] border border-[hsl(var(--brand)/0.2)]">
              ...
              <span className="text-[hsl(var(--brand))] font-semibold">
                Optimized for low-bandwidth environments and real-time
                processing
              </span>
            </div>
          </div>
        ...
        <div className="container mx-auto max-w-6xl px-4">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
              Our system combines multiple AI branches to deliver accurate,
              secure, and real-time identity verification
            </p>
          </div>
              ...
              <tbody>
                <tr className="border-b hover:bg-muted/50 transition-colors">
                  ...
                  <td className="p-4 text-muted-foreground">
                    Detects a face from webcam input and compares it to known
                    faces in database.
                  </td>
                </tr>
                <tr className="border-b hover:bg-muted/50 transition-colors">
                  ...
                  <td className="p-4 text-muted-foreground">
                    Verifies if the face input is real (not a photo or screen).
                  </td>
                </tr>
                <tr className="border-b hover:bg-muted/50 transition-colors">
                  ...
                  <td className="p-4 text-muted-foreground">
                    Assigns a score to how confident the system is in the face
                    match.
                  </td>
                </tr>
                <tr className="border-b hover:bg-muted/50 transition-colors">
                  ...
                  <td className="p-4 text-muted-foreground">
                    Flags unusual attempts or repeated mismatches.
                  </td>
                </tr>
                <tr className="hover:bg-muted/50 transition-colors">
                  ...
                  <td className="p-4 text-muted-foreground">
                    Provides real-time guidance or explanations to the
                    user/officer.
                  </td>
                </tr>
              </tbody>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-muted-foreground">
              All AI models are optimized for low-bandwidth environments and
      ...
      <footer className="bg-muted/30 border-t">
        <div className="container mx-auto max-w-6xl px-4 py-12">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-muted-foreground mb-4 max-w-md">
                Advanced AI-powered face recognition and identity verification
                system designed for Africa's security and identification needs.
              </p>
          ...
          <div className="border-t mt-8 pt-8 flex items-center justify-between text-sm text-muted-foreground">
            <p>
              © {new Date().getFullYear()} FaceTrust AI. Built for Africa's
              digital future.
            </p>
            <div className="flex items-center gap-4">
              <span className="px-2 py-1 rounded bg-[hsl(var(--brand)/0.12)] text-[hsl(var(--brand))] text-xs font-medium">
                v1.0.0
              </span>
